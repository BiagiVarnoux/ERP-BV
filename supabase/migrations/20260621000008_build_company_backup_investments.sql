-- Agrega las tablas del módulo de Análisis de Inversión al backup server-side.
-- Mantiene la MISMA forma que BackupData (src/services/backupService.ts) para que
-- un snapshot del servidor se restaure por el mismo camino del cliente.
