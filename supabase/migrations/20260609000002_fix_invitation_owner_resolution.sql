-- Corregir la resolución del owner en redeem_invitation_code.
-- En vez de "owner más antiguo" (heurística que falla cuando se recrean cuentas),
-- buscar el owner con más datos contables reales (cuentas + asientos).
...
BEGIN
  ...
  -- Más robusto que "más antiguo" cuando se recrean cuentas.
