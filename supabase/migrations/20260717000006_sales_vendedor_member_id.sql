-- Atribución interna (nunca visible al vendedor) de qué vendedor cerró una
-- venta, para calcular a quién pagarle comisión. Nullable = ningún vendedor
-- (el dueño/staff la vendió directo).
ALTER TABLE public.sales
  ADD COLUMN IF NOT EXISTS vendedor_member_id uuid REFERENCES public.company_members(id);

-- create_sale: agrega el parámetro opcional vendedor_member_id al payload.
-- Resto de la función sin cambios respecto a 20260617000002_cxc_electronica_pedido.sql.
