-- RPC que renombra el código de una cuenta del plan de cuentas en una sola transacción.
-- Actualiza todos los registros relacionados: journal_lines, auxiliary_ledger,
-- auxiliary_ledger_definitions y company_sale_account_config.
-- SECURITY DEFINER: bypasa RLS, la seguridad la da el WHERE company_id = p_company_id.
