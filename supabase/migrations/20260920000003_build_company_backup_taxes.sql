-- Backup server-side: incluir tax_documents (Libro de Compras/Ventas IVA).
-- Tercer lugar que debe mantenerse en sync con backupService.ts (regla 2).
-- `payables.sin_credito_fiscal` viaja dentro de 'payables' (to_jsonb de la fila).
