-- Backfill: siembra la fila de permisos 'investments' para los miembros no-owner
-- existentes, con los defaults de su rol. ON CONFLICT DO NOTHING para NO pisar
-- permisos ya personalizados. Los owners quedan cubiertos por el fallback del
-- frontend (ALL_MODULES), no necesitan filas.
