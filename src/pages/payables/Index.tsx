            ...
            return (
              <DataCard key={row.id} className={row.estado === 'voided' ? 'opacity-60' : ''}>
                ...
                <DataCardGrid className="mt-3">
                  ...
                  <DataCardField label="NIT"><span className="font-mono">{row.proveedor_nit ?? '—'}</span></DataCardField>
                ...
                {canPay && (
                  <DataCardActions className="mt-2 pt-2 border-t">
                    <Button size="sm" variant="outline" className="flex-1" onClick={() => openEditModal(row)}>Editar</Button>
                    <Button size="sm" variant="outline" className="flex-1" onClick={() => openPayModal(row)}>Registrar pago</Button>
                  </DataCardActions>
                )}
              </DataCard>
            );
